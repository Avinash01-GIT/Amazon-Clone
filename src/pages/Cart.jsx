      ...
      <div className="container mx-auto h-auto grid grid-cols-5 gap-8 ">
        <div className="w-full h-full bg-white px-4 col-span-4">
              ...
              >
                <div className="w-full flex items-center gap-6">
                  ...
                  <div className="w-4/5">
                    ...
                    <p className="text-sm">{item.description.substring(0,180)}</p>
                    ...
                    <div className="flex justify-center items-center gap-2 w-24 py-1 text-center bg-[#F0F2F2] drop-shadow-lg rounded-md">
                      <p>Qty:</p>
                      <p onClick={() => dispatch(decrementQuantity(item.id))} className="bg-gray-200 px-1 cursor-pointer rounded-md hover:bg-gray-400 duration-300">
                        -
                      </p>
                      <p>{item.quantity}</p>
                      <p onClick={() => dispatch(incrementQuantity(item.id))} className="bg-gray-200 px-1 cursor-pointer rounded-md hover:bg-gray-400 duration-300">
                        +
                      </p>
                    </div>
                    <button onClick={() => dispatch(deleteItem(item.id))} className="bg-gray-200 px-1 cursor-pointer rounded-md hover:bg-yellow-400 duration-300">
                      Delete Item
                    </button>
                  </div>
                  <div>
          ...
          <div  onClick={() => dispatch(resetCart())} className="w-full py-2">
            <button className="px-5 py-1 bg-red-500 hover:bg-red-600 active:bg-red-500 text-white rounded-lg font-titleFont font-semibold text-lg tracking-wide ">Clear Cart</button>
          </div>
        </div>
